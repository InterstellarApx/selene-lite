...
public class SoundUtil {
   ...
   public static void playSound_mp3(String sound, float value, boolean nonstop) {
      if (SUPPORTED) {
         Engine.playMp3(sound, value, nonstop);
      }
   }

   public static void playSound_wav(String location, float volume) {
      if (SUPPORTED) {
         Engine.playWav(location, volume);
      }
   }
   ...
   private static final class Engine {
      ...
      private static void playMp3(String sound, float value, boolean nonstop) {
      ...
      private static void playWav(String location, float volume) {
         purgeFinishedClips();
